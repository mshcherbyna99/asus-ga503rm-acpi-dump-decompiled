 ...
 *
 * Disassembly of C:/Users/Rog/Xiasl/ACPI Tables/ssdt12.dat, Sat Sep 27 14:31:22 2025
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000047F0 (18416)
 *     Revision         0x01
 *     Checksum         0x3D
 *     OEM ID           "AMD"
...
DefinitionBlock ("", "SSDT", 1, "AMD", "AmdTable", 0x00000001)
{
    ...
    External (_SB_.PCI0.GP17.ACP_.P_OF, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.ACP_.P_ON, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.ACP_.PSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.ACP_.SINI, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.ACP_.SREG, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.GP17.ACP_.SSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.AZAL, DeviceObj)
    External (_SB_.PCI0.GP17.AZAL._ADR, IntObj)
    External (_SB_.PCI0.GP17.AZAL.P_OF, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.AZAL.P_ON, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.AZAL.PSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.AZAL.SINI, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.AZAL.SREG, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.GP17.AZAL.SSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.HDAU, DeviceObj)
    External (_SB_.PCI0.GP17.HDAU._ADR, IntObj)
    External (_SB_.PCI0.GP17.HDAU.P_OF, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.HDAU.P_ON, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.HDAU.PPS0, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.HDAU.PPS3, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.HDAU.PSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.HDAU.SINI, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.HDAU.SREG, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.GP17.HDAU.SSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.P_OF, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.P_ON, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.PPS0, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.PPS3, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.PSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.SINI, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.SREG, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.GP17.SSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.VGA_, DeviceObj)
    External (_SB_.PCI0.GP17.VGA_._ADR, IntObj)
    External (_SB_.PCI0.GP17.VGA_.P_OF, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.VGA_.P_ON, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.VGA_.PPS0, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.VGA_.PPS3, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.VGA_.PSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.VGA_.SINI, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.VGA_.SREG, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.GP17.VGA_.SSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC0, DeviceObj)
    External (_SB_.PCI0.GP17.XHC0._ADR, IntObj)
    External (_SB_.PCI0.GP17.XHC0.P_OF, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC0.P_ON, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC0.PPS0, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC0.PPS3, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC0.PSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC0.SINI, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC0.SREG, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.GP17.XHC0.SSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC1, DeviceObj)
    External (_SB_.PCI0.GP17.XHC1._ADR, IntObj)
    External (_SB_.PCI0.GP17.XHC1.P_OF, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC1.P_ON, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC1.PPS0, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC1.PPS3, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC1.PSTA, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC1.SINI, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.GP17.XHC1.SREG, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.GP17.XHC1.SSTA, MethodObj)    // 0 Arguments
    ...
    Scope (\_SB.PCI0.GP17.ACP)
    {
        Method (_WOV, 0, Serialized)
        {
            ...
            M460 ("  OEM-ASL-\\_SB.PCI0.GP17.ACP._WOV Return %d\n", Local0, Zero, Zero, Zero, Zero, Zero)
            Return (Local0)
        }
