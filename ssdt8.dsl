 ...
 *
 * Disassembly of C:/Users/Rog/Xiasl/ACPI Tables/ssdt8.dat, Sat Sep 27 14:30:41 2025
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00007943 (31043)
 *     Revision         0x01
 *     Checksum         0x82
 *     OEM ID           "AMD"
...
DefinitionBlock ("", "SSDT", 1, "AMD", "AmdTable", 0x00000001)
{
    ...
    OperationRegion (CPNV, SystemMemory, 0x78DF5018, 0x000100F7)
    ...
    Method (M4E0, 5, Serialized)
    {
        ...
        Local0 = (0xFED81E4A + (Arg0 * 0x02))
        Local1 = (0xFEDC2000 + (Arg0 * 0x1000))
        ...
        OperationRegion (VAR2, SystemMemory, 0xFED80D00, 0x0100)
        Field (VAR2, ByteAcc, NoLock, Preserve)
        {
            Offset (0x13), 
            IO3C,   8, 
            IO3D,   8, 
